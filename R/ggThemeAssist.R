...
ggThemeAssist <- function(){
  ...
  server <- function(input, output, session) {
    ...
    updateSelectizeInput(session = session, inputId = 'plot.background.fill', choices = colour.choices, selected = default$plot.background$fill, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'panel.background.fill', choices = colour.choices, selected = default$panel.background$fill, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'plot.background.colour', choices = colour.choices, selected = default$plot.background$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'panel.background.colour', choices = colour.choices, selected = default$panel.background$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'panel.grid.major.colour', choices = colour.choices, selected = default$panel.grid.major$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'panel.grid.minor.colour', choices = colour.choices, selected = default$panel.grid.minor$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'axis.line.colour', choices = colour.choices, selected = default$axis.line$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'axis.ticks.colour', choices = colour.choices, selected = default$axis.ticks$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'axis.text.colour', choices = colour.choices, selected = default$axis.text$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    ...
    updateSelectizeInput(session = session, inputId = 'plot.title.colour', choices = colour.choices, selected = default$plot.title$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'axis.title.colour', choices = colour.choices, selected = default$axis.title$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.background.fill', choices = colour.choices, selected = default$legend.background$fill, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.key.fill', choices = colour.choices, selected = default$legend.key$fill, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.title.colour', choices = colour.choices, selected = default$legend.title$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.text.colour', choices = colour.choices, selected = default$legend.text$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.background.colour', choices = colour.choices, selected = default$legend.background$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.key.colour', choices = colour.choices, selected = default$legend.key$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'panel.background.fill', choices = colour.choices, selected = default$panel.background$fill, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
    updateSelectizeInput(session = session, inputId = 'legend.key.colour', choices = colour.choices, selected = default$legend.key$colour, server = TRUE, options = list(create = TRUE, labelField = 'name', searchField = 'colour', valueField = 'colour', render = jsColourSelector))
